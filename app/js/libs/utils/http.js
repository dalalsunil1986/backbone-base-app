define([
    ...
    return {
        ...
        //to be always used when assigning a url to a model
        createUrl:function (url) {
            
            var firstChar = url.substr(0); // Selects the first character
            if (firstChar != '/') {         // If the first character is not a slash
                url = '/' + url;            // prepend a slash to it.
            }
            
            return (appConfig.basePath + url);
        },
